...
public class MultiWayTreeTest {
	...
	void fromFlatBuildsOrgChart() {
		MultiWayTree<String> org = MultiWayTree.fromFlat(List.of(MultiWayTree.FlatNode.root("ceo", "CEO"),
				MultiWayTree.FlatNode.of("eng", "ceo", "Engineering"), MultiWayTree.FlatNode.of("hr", "ceo", "HR"),
				MultiWayTree.FlatNode.of("be", "eng", "Backend"), MultiWayTree.FlatNode.of("fe", "eng", "Frontend")));
	...
	void bfsOrderIsLevelOrder() {
		MultiWayTree<String> org = MultiWayTree.fromFlat(List.of(MultiWayTree.FlatNode.root("1", "A"),
				MultiWayTree.FlatNode.of("2", "1", "B"), MultiWayTree.FlatNode.of("3", "1", "C")));
	...
	void rejectDuplicateOrMissingParent() {
		assertThrows(IllegalArgumentException.class, () -> MultiWayTree
				.fromFlat(List.of(MultiWayTree.FlatNode.root("1", "a"), MultiWayTree.FlatNode.of("1", "1", "dup"))));
		assertThrows(IllegalArgumentException.class, () -> MultiWayTree.fromFlat(
				List.of(MultiWayTree.FlatNode.root("1", "a"), MultiWayTree.FlatNode.of("2", "missing", "b"))));
